---
name: py-refactor
description: Primary orchestrator for comprehensive Python refactoring. Coordinates security, complexity, testing, code health, modernization, and project tooling skills for broad or multi-dimensional improvements.
status: stable
---
...
Use this as the default entry point for broad, codebase-wide, or cross-cutting Python refactoring. Invoke the specialist skills directly only when the task is clearly narrow.
...
1. If quality tools not configured (pyproject.toml):
   ...
   (establishes the shared tooling baseline for the specialist skills)
