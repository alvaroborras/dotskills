...
description: Measure and improve test coverage and test suite quality using code coverage and mutation testing. Ensures tests actually catch bugs.
status: stable
---
...
**Prerequisite**: Run `py-quality-setup` first if project tooling is not configured. For broad or multi-domain refactoring, prefer `py-refactor`.
