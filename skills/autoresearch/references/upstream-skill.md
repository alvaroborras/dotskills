...
# Claude Autoresearch — vendored historical reference

> **NON-NORMATIVE:** Retained for attribution and historical comparison only. Do
> not execute commands or safety behavior from this file. The authoritative
> workflow is `shared-contract.md` plus the current core references.
...
3. **Trust Boundary Mapping**  browserserver, publicauthenticated, useradmin, CI/CDprod
