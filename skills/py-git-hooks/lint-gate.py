#!/usr/bin/env python3
"""Generic lint-gate helper for agent platforms with stop hooks.
...
the agent returns to the user. If unfixable errors remain, blocks the stop
with the error output so the agent can fix them first.
"""
